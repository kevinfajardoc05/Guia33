...
public class fisicoquimicooo {
    ...
    public Iterator<fisicoquimicooo> listar() {
        ...
        try {
            ...
            unFisi.setCodigomuestra(rs.getString("codigomuestra"));
    ...
    public void insertar() {
        try {
            ...
            sql.setString(12, this.getCodigomuestra());
            sql.setString(13, this.getPh());
            sql.setString(14, this.getConducti());
            sql.setString(15, this.getColor());
            sql.setString(16, this.getTurbiedad());
            sql.setString(17, this.getClororecidulibre());
            sql.setString(18, this.getCalcio());
            sql.setString(19, this.getAlcalinidad());
            sql.setString(20, this.getCloruros());
            sql.setString(21, this.getDureza());
            sql.setString(22, this.getHierro());
            sql.setString(23, this.getSulfato());
            sql.setString(24, this.getNitrito());
            sql.setString(25, this.getNitrato());
            sql.setString(26, this.getAluminio());
            sql.setString(27, this.getFosfato());
            sql.setString(28, this.getClorolibre());
            sql.setString(29, this.getOtros());
            sql.setString(30, this.getAplica());
            sql.setString(31, this.getCodintmues());
            sql.setString(32, this.getResponsable());
            sql.setString(33, this.getObservaciones());
            sql.setString(34, this.getObsanalisis());
            sql.setString(35, this.getFechpreparacion());
            sql.setString(36, this.getHorapreparacion());
            sql.setString(37, this.getFechaconteo());
            sql.setString(38, this.getHoraconteo());
            sql.setString(39, this.getColiformes());
            sql.setString(40, this.getEscherichia());
            sql.setString(41, this.getMesolitos());
            sql.setString(42, this.getAplicacont());
            sql.setString(43, this.getRespconteo());
            sql.setString(44, this.getObsconteo());
            sql.setString(45, this.getObsgeconteo());
            sql.executeUpdate();
    ...
    public void modificar() {
        try {
            ...
            sql.setString(11, this.getCodigomuestra());
    ...
    public Iterator<fisicoquimicooo> buscar(String busqueda) {
        ...
        try {
            ...
            fisic.setCodigomuestra(rs.getString("codigomuestra"));
